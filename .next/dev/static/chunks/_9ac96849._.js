...
"[project]/app/profile/orders/[id]/invoice/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CustomerInvoicePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomerInvoicePage.useEffect": ()=>{
            ...
            const loadData = {
                "CustomerInvoicePage.useEffect.loadData": async ()=>{
                    try {
                        setLoading(true);
                        const [orderData, settingsData] = await Promise.all([
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$profile$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrderById"])(orderId),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStorefrontSettings"])()
                        ]);
            ...
            }["CustomerInvoicePage.useEffect.loadData"];
            loadData();
        }
    }["CustomerInvoicePage.useEffect"], [
        orderId
        ...
        "CustomerInvoicePage.useEffect": ()=>{
            if (!loading && order && settings) {
                const timer = setTimeout({
                    "CustomerInvoicePage.useEffect.timer": ()=>{
                        window.print();
                    }
                }["CustomerInvoicePage.useEffect.timer"], 800); // Small delay to ensure styles and content render fully
                return ({
                    "CustomerInvoicePage.useEffect": ()=>clearTimeout(timer)
                })["CustomerInvoicePage.useEffect"];
            }
        }
    }["CustomerInvoicePage.useEffect"], [
...
_s(CustomerInvoicePage, "WcSJMUS32GHuTsgGIyeWpMiOfeI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = CustomerInvoicePage;
var _c;
__turbopack_context__.k.register(_c, "CustomerInvoicePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_9ac96849._.js.map