...
;
;
function AddToCartButton({ product, className = "ig-add-cart-btn", label }) {
    ...
    const onClick = async ()=>{
        ...
        try {
            setLoading(true);
            setMessage("");
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cart$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["addToCart"])(product.id, defaultVariant?.id);
            setMessage("Added");
...
//# sourceMappingURL=_4ccca186._.js.map