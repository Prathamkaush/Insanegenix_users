...
function ProductReviewSection({ productId, initialAverage, initialTotal }) {
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            setSubmitting(true);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$reviews$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["submitProductReview"])(productId, rating, trimmedComment);
            setComment("");
            setRating(0);
            setHoverRating(0);
