...
function CartPage() {
    ...
    const notifyCartCount = (nextItems)=>{
    ...
    const changeQuantity = async (item, quantity)=>{
        ...
        setItems((current)=>{
            const nextItems = current.map((currentItem)=>currentItem.id === item.id ? {
                    ...currentItem,
                    quantity
                } : currentItem);
    ...
    const removeItem = async (id)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cart$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["removeCartItem"])(id);
        setItems((current)=>{
